...
# How do new profiles look like now? Improving plotting function before maybe
print("Starting to process CARRA data")
if True: 
    # Loading Carra multilevel and 2m and tskin and merging the data bysed on height above ground
    lon_min = -18
    lon_max = -14
    lat_min = 80
    lat_max = 83
    ...
    # Call the function with hardcoded dataset paths
    process_and_combine_CARRA_datasets(
...
if True: 
    ...
    resample_interpolate_merge_profiles(path1, path2, path3, output_directory="data\\merged_interpol_profiles", interpolation_method='pchip', step=1)
