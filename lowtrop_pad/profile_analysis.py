        ...
        if file.endswith(".csv"):
            ...
            if "carra" in file:
                if "all_profiles" in file:
                    ...
                    mean_differences_carra_df["mean_all_profiles"] = df.iloc[
                        :, 1:
                    ].mean(axis=1, skipna=True)
                elif "tundra" in file:
                    mean_differences_carra_df["mean_tundra"] = df.iloc[:, 1:].mean(
                        axis=1, skipna=True
                    )
                elif "water" in file:
                    mean_differences_carra_df["mean_water"] = df.iloc[:, 1:].mean(
                        axis=1, skipna=True
                    )
                elif "ice" in file:
                    mean_differences_carra_df["mean_ice"] = df.iloc[:, 1:].mean(
                        axis=1, skipna=True
                    )
                elif "lake" in file:
                    mean_differences_carra_df["mean_lake"] = df.iloc[:, 1:].mean(
                        axis=1, skipna=True
                    )
                ...
                if "all_profiles" in file:
                    ...
                    mean_differences_era5_df["mean_all_profiles"] = df.iloc[:, 1:].mean(
                        axis=1, skipna=True
                    )
                elif "tundra" in file:
                    mean_differences_era5_df["mean_tundra"] = df.iloc[:, 1:].mean(
                        axis=1, skipna=True
                    )
                elif "water" in file:
                    mean_differences_era5_df["mean_water"] = df.iloc[:, 1:].mean(
                        axis=1, skipna=True
                    )
                elif "ice" in file:
                    mean_differences_era5_df["mean_ice"] = df.iloc[:, 1:].mean(
                        axis=1, skipna=True
                    )
                elif "lake" in file:
                    mean_differences_era5_df["mean_lake"] = df.iloc[:, 1:].mean(
                        axis=1, skipna=True
                    )
